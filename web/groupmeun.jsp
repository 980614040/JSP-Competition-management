...
<div class="middle">
    ...
    <div class="right_view">
        ...
        <form action="checks.checks" method="post">
            <div class="right_nav">
                ...
                <table width="551" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
                    <tr>
                        ...
                        <td width="120" bgcolor="#CCCCCC">审核</td>

                        <td width="108" bgcolor="#CCCCCC">操作</td>
                    </tr>
                    <%
                        DBUtils dob=new DBUtils();
                        String[] temp = {"group_id","group_name","checks"};
//      List<String[]> vec = dob.find("book",temp,null);
                        ...
                        int pageSize = 10;
                        List<String[]> vec1 = dob.find("groups",temp,"");
                        int total = vec1.size();
                        int pageCount = total % pageSize ==0 ? total / pageSize : total / pageSize+1;//总的页码

                        List<String[]> vec = dob.find("groups",temp,"1=1 order by group_id desc limit "+(pageNum-1)*pageSize+","+pageSize+"");//排序 页码pageNum 每页pageSize=10条，
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF"><a href="detail.jsp?id=<%=ss[0]%>" target=_blank>查看</a>/
                            <a href="checks.checks?group_id=<%=ss[0] %>&&checks=0">审核不通过</a>/
                            <a href="checks.checks?group_id=<%=ss[0] %>&&checks=1">审核通过</a></td>
                    </tr>
                    <% } %>
                </table>
                <%
